      ...
      <div className="container h-100">
        <div className="row h-100">
          <div className="col-md-6 d-flex flex-column justify-content-center align-items-start">
            <div className="about-header-left">
              ...
              <p data-aos="fade-up" data-aos-delay="200">
                We allow all developers & designers to show own creativity.
                Submit your resume with your key skills.Secure is a leading IT
                company based in Surat, Gujarat, India, started with a principal
          ...
          <div className="col-md-6 d-flex align-items-center">
            <div>
              <img src={images.contactus} alt="" className="img-fluid" />
              {/* <Lottie
              options={{
                loop: true,
                autoplay: true,
